  ...
  return (
    <div className="container mx-auto w-full space-y-8">
            ...
            <Card className="text-md w-full space-y-1 p-3">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-green-600">
                  £{enrollment.orderTotalPrice}
                </span>
              </div>
              <div className="flex justify-between font-medium text-primary">
                <span>Paid Deposit (20%)</span>
                <span className="text-green-600">
                  {formattedPrice(depositAmount)}
                </span>
              </div>
      ...
      <Elements options={{ clientSecret }} stripe={stripePromise}>
        <Form orderPrice={remainingBalance} />
      </Elements>
    </div>
  );
};
...
export default FullPaymentCheckOutForm;
