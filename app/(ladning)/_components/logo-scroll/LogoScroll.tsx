...
const LogoScroll = () => {
  ...
  const scaleMobile = useTransform(scrollYProgress, [0, 0.5], [3, 1]);
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="fixed left-0 top-0 z-[100] h-full w-full p-3 text-5xl font-bold text-red-500"
      >
        {/* SCREEN LOGO */}
        <motion.div
          style={{ scale }}
        ...
        {/* MOBILE LOGO */}
        <motion.div
          style={{ scale: scaleMobile, transform: transformMobile }}
          className="fixed left-0 top-0 p-3 sm:hidden"
        >
          <h3>AMIO</h3>
        </motion.div>
      </motion.div>
